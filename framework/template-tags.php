...
function xclean_page_head() { ?>
	<!-- change "true" to "is_front_page()" to get page-head back-->
	<?php if ( ! true ) : ?>
		<div class="page-head">
			<div class="container">
				<div class="row">
...
function xclean_share_buttons() { ?>
	...
	<ul class="post-social <?php echo $class; ?>">
		<li><?php esc_html_e( 'Share post', 'xclean' ); ?></li>
...
function xclean_post_meta(){
	...
	if ( get_post_type() === 'post' ) {
		...
		/**
 		 ...
 		 */
		printf(
			'<li class="meta-author">%1$s <a href="%2$s" rel="author">%3$s</a></li>',
			esc_html__( 'By', 'xclean' ),esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
			get_the_author()
		);
